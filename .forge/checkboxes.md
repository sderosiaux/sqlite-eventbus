...
| CHK-007 | EVENTBUS-SPECIFICATION.md:70 | checkbox | **Dispatcher retry** with exponential backoff (base delay, max delay, max retries) | 3 | `src/dispatcher/retry.test.ts:26` | `d0d0479` | DONE |
| CHK-008 | EVENTBUS-SPECIFICATION.md:71 | checkbox | **Dispatcher DLQ routing** after max retries exhausted, with failure context | 3 | `src/dispatcher/retry.test.ts:146` | `d0d0479` | DONE |
...
| CHK-014 | RETRY-POLICY.md:44 | checkbox | **Jitter**: Add ±10% random jitter to prevent thundering herd | 3 | `src/dispatcher/retry.test.ts:236` | `d0d0479` | DONE |
