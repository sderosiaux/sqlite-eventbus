...
| CHK-016 | EVENTBUS-SPECIFICATION.md:251 | checkbox | **Circuit breaker half-open probe** — send single probe event before fully reopening (current: simple reset) | 5 | src/dispatcher/circuit-breaker.test.ts:183,233,266,304,338 | - | DONE |
