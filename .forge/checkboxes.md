...
| CHK-016 | EVENTBUS-SPECIFICATION.md:251 | checkbox | **Circuit breaker half-open probe** — send single probe event before fully reopening (current: simple reset) | 5 | src/dispatcher/circuit-breaker.test.ts:183,199,266,299 | - | DONE |
